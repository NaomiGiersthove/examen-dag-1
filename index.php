...
<body>
    ...
    ?>
        <header class="p-3 bgcolor:white text-black">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-black text-decoration-none">
                        <svg class="bi me-2" width="40" height="32" role="img" aria-label="Bootstrap">
                    ...
                    <a href="index.php"><img src="logo.png" alt="Logo" width="50" height="50"></a>
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        <li><a href="index.php" class="nav-link px-2 text-black" style="background-color: lightblue;">ReMaS Superior Waste Recycling</a></li>
                    </ul>

                    <div class="text-end">
                        <a style="background-color: lightblue;">versie 1.00</a>
                        <a href="medewerker-login.php"><button type="submit" class="btn btn-outline-light me-2" style="background-color:green;">Login</button></a>
                        <a onclick="return confirm('Vul de code in om een account aan te maken.')" href="signup-confirm.php"><button type="button" class="btn btn-outline-light me-2" style="background-color:green;">Registreer</button></a>
                    </div>
                </div>
            </div>
        </header>
